 ...
 * @remark
 * #. anybody can see but only visible from inside authorized pages
 * @todo
 * #. fix up bootstrap navbar
 * #. screenshot gallery
 * #. docblocks
 */
...
<body>
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">Administration <b class="caret"></b>
					</a>
	...
	<div class="jumbotron">
		<div class="container">
			<h1>
				Quick Help<small>&nbsp; MyIEP (Version <?php echo $IPP_CURRENT_VERSION; ?>)
				</small>
			</h1>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<div class="alert alert-block alert-danger">
					...
					<em>MyIEP</em> is not designed for compatibility with Microsoft's
					Internet Explorer.
				</div>
				<p>
					<em>MyIEP</em> is optimized for the following browsers:
				</p>
				<ul>
				...
				<h2>JavaScript</h2>
				<p>
					JavaScript must be permitted to run in your browser for <em>MyIEP</em>
					to function.
				</p>
				<a href="http://www.heart.org/HEARTORG/form/enablescript.html"
					title="How to Enable JavaScript" class="btn btn-default">Learn How
					to Enable JavaScript &raquo;</a>
			...
			<div class="col-md-4">
				...
				<address>
					2970 Belcrest Center Drive - Suite 300<br> Hyattsville, Maryland
					20782
				</address>
				<h3>Legacy Code</h3>
		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				<address>
					<strong>The Free Software Foundation, Inc.</strong><br> 59 Temple
					Place, Suite 330, Boston, <abbr title="Massachussetes">MA</abbr>
					02111-1307<br> USA
				</address>
				<p>
			...
			<div class="col-md-4">
				...
				<ul>
					...
					<li>HTML5 &amp; CSS3</li>
					<li><a href="http://vagrantup.com">Vagrant</a> &amp; Virtualbox
					...
					<li>Responsive design (in progress) with <a
		...
		<div class="row">
			<div class="col-md-4">
				...
				<p>Thorough documentation for IEP-IPP, the software upon which MyIEP
					is based, is available in PDF format - except the installation
					guide, which is in MS Word format.</p>
				...
				<select
					...
					name="docs" title="Get the Docs" class="selectpicker"
					data-style="btn-inverse">
					<option value="">Get Docs</option>
					<option value="http://iep-ipp.sourceforge.net/documents/v1User.pdf">End-User
						Documentation</option>
					<option
						value="http://iep-ipp.sourceforge.net/documents/v1Admin.pdf">Administrator's
						Guide</option>
					<option
						value="http://iep-ipp.sourceforge.net/documents/v1.0%20Installation.doc">Installation
						Guide</option>
				</select>
    ...
    ================================================== -->
		...
		<?php print_intellectual_property()?>
