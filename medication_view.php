 ...
 * @todo
 * #. docblock commenting
 * #. do something about legacy buttons with attached javascript
 */
...
if(isset($_GET['add_medication']) && $have_write_permission) {
   ...
   if($_GET['medication_name'] == "") $system_message = $system_message . "You must give a medication name<BR>";
     ...
     if(!preg_match($regexp,$_GET['start_date'])) { $system_message = $system_message . "Date must be in YYYY-MM-DD format. You entered " . $get['start_data'] . "<BR>"; }
     else {
