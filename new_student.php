...
function parse_submission()
{
 ...
 if ($_POST['prov_ed_num'] != "") {
  ...
  if (mysql_num_rows($duplicate_result) > 0) {
   $duplicate_row = mysql_fetch_array($duplicate_result);return "Duplicate Provincial Education Number (name:" . $duplicate_row['first_name'] . " " . $duplicate_row['last_name'] ."),<BR>This student probably already exists in the database<BR>";
  }
 }
...
?>
<link
	rel="stylesheet" href="./css/smoothness/jquery-ui.css">
<script src="js/jquery-2.1.1.js"></script>
<script
	src="js/smoothness/jquery-ui-1.10.4.custom.js"></script>
...
<BODY>
	...
	<div class="container">
		...
		<form name="addName" enctype="multipart/form-data"
			action="<?php echo IPP_PATH . "new_student.php"; ?>" method="post">
			<div class="form-group">
				<input type="hidden" name="add_student" value="1"> <label for
					first_name>First Name</label> <input class="form-control"
					type="text" autocomplete="off" placeholder="First Name" required
					name="first_name" size="30" maxsize="125"
					value="<?php if(isset($_POST['first_name'])) echo $_POST['first_name'];?>">

				<label for last_name>Last Name</label> <input class="form-control"
					type="text" autocomplete="off" placeholder="Last Name" required
					name="last_name" size="30" maxsize="125"
					value="<?php if(isset($_POST['last_name']))  echo $_POST['last_name']; ?>">
				<label for birthday>Birthdate (YYYY-MM-DD)</label> <input
					class="form-control datepicker" autocomplete="off"
					data-provide="datepicker" required data-date-format="yyyy-mm-dd"
					type="datepicker" id="datepicker" name="birthday"
					value="<?php if(isset($_POST['birthday'])) echo $_POST['birthday']; ?>">

				<label for school_code>School</label> <SELECT required
					class="form-control" name="school_code">
					<?php
...
?>
				</SELECT> <label for at_school_since>At School Since (YYYY-MM-DD)</label>
				<input autocomplete="off" placeholder="Attending school since..."
					class="form-control datepicker" required type="datepicker"
					data-provide="datepicker" data-date-format="yyyy-mm-dd"
					name="at_school_since"
					value="<?php if(isset($_POST['at_school_since'])) echo $_POST['at_school_since']; else echo date("Y-m-d"); ?>">

				<label for current_grade>Current Grade</label> <SELECT
					class="form-control" name="current_grade">
					<OPTION value="0"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "0") echo "selected"; ?>>K
						or Pre-K
					
					<OPTION value="1"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "1") echo "selected"; ?>>1


					
					
					<OPTION value="2"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "2") echo "selected"; ?>>2


					
					
					<OPTION value="3"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "3") echo "selected"; ?>>3


					
					
					<OPTION value="4"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "4") echo "selected"; ?>>4


					
					
					<OPTION value="5"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "5") echo "selected"; ?>>5


					
					
					<OPTION value="6"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "6") echo "selected"; ?>>6


					
					
					<OPTION value="7"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "7") echo "selected"; ?>>7


					
					
					<OPTION value="8"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "8") echo "selected"; ?>>8


					
					
					<OPTION value="9"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "9") echo "selected"; ?>>9


					
					
					<OPTION value="10"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "10") echo "selected"; ?>>10


					
					
					<OPTION value="11"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "11") echo "selected"; ?>>11


					
					
					<OPTION value="12"
					<?php if(isset($_POST['current_grade']) && $_POST['current_grade'] == "12") echo "selected"; ?>>12



					
				
				</SELECT> <label for gender>Gender</label> <SELECT
					autocomplete="off" required class="form-control" name="gender">
					<option value="M">Male
...
<input type="text" size="30" maxsize="60" name="prov_ed_num" value="<?php if(isset($_POST['prov_ed_num'])) echo $_POST['prov_ed_num'];?>">-->
			...
			<input type="hidden" name="szBackGetVars"
				value="<?php echo $szBackGetVars; ?>">
