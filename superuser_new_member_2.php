 ...
 * @author s Rik Goldman, Sabre Goldman, Jason Banks, Alex, James, Paul, Bryan, TJ, Jonathan, Micah, Stephen, Joseph
 * @author M. Nielson
...
if (isset ( $system_message ))
	...
	$system_message = "";
if (isset ( $szBackGetVars ))
	$szBackGetVars = $szBackGetVars;
else
	$szBackGetVars = "";
...
$szBackGetVars = "";
if (isset ( $_GET ['szBackGetVars'] ))
	$szBackGetVars = $_GET ['szBackGetVars'];
if (isset ( $_POST ['szBackGetVars'] ))
	$szBackGetVars = $_POST ['szBackGetVars'];
...
<h2>Enter Account Details</h2>
        ...
        <form autocomplete="off" name="addName"
            enctype="multipart/form-data"
            action="<?php echo IPP_PATH . "superuser_new_member_2.php"; ?>"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
						...
						<label>First Name</label> <input required class="form-control"
                            ...
                            tabindex="2"> <label>Last Name</label> <input
                            class="form-control" required type="text"
                            name="last_name" value="" tabindex="3"> <label>Email
                            Address</label> <input class="form-control"
                            required type="EMAIL" name="email" required
                            tabindex="4">
                    </div>
                </div>
                <div class="col-md-6 form-group">
                    ...
                    <label>Confirm Password</label> <input
                        ...
                        pattern="(?=^.{6,30}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[!@#$%^&*])(?=.*[A-Z])(?=.*[a-z]).*$"
                        tabindex="6"> <label>Permission Level</label>
					<?php
					...
					<label>School</label> <select class="form-control" tabindex="8"
                        ...
                        name="szBackGetVars"
                        value="<?php echo $szBackGetVars; ?>;"> <input
                        type="hidden" name="egps_username"
                        value="<?php echo $_GET['egps_username'] ?>;">
                    <p>
                        <button class="btn btn-default" type="submit"
                            value="Add" tabindex="10">Create Account</button>
                    </p>
