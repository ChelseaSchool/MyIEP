...
<BODY>
	...
	<h2>
            Edit and click <em>Update Student Information</em>
        </h2>
        <!-- Begin Form -->
        <form name="addName" enctype="multipart/form-data"
            action="<?php echo "edit_general.php"; ?>" method="post">
            <input type="hidden" name="modify_student" value="1"> <input
            ...
            <div class="form-group">
                <label>First Name</label> <input class="form-control"
                    ...
                    value="<?php echo $student_row['first_name']; ?>">
            </div>
            <div class="form-group">
                <label>Last Name</label> <input class="form-control"
                    type="text" autocomplete="off" required
                    name="last_name" size="30" maxsize="125"
                    value="<?php echo $student_row['last_name']; ?>">
            </div>
            <div class="form-group">
                <label>Birthdate (YYYY-MM-DD)</label> <input
                    autocomplete="off" class="form-control datepicker"
                    type="datepicker" id="datepicker"
                    data-provide="datepicker"
                    data-date-format="yyyy-mm-dd" required
                    name="birthday"
                    value="<?php echo $student_row['birthday']; ?>">
            </div>
            <div class="form-group">
                <label>Entry Grade</label> <SELECT class="form-control"
                    name="current_grade">
                    <OPTION value="-1"
                        <?php if($student_row['current_grade'] == "-1") echo "selected"; ?>>District
                        Program
                    
                    <OPTION value="0"
                        <?php if($student_row['current_grade'] == "0") echo "selected"; ?>>K
                        or Pre-K
                    
                    <OPTION value="1"
                        <?php if($student_row['current_grade'] == "1") echo "selected"; ?>>1
                    
                    
                    <OPTION value="2"
                        <?php if($student_row['current_grade'] == "2") echo "selected"; ?>>2
                    
                    
                    <OPTION value="3"
                        <?php if($student_row['current_grade'] == "3") echo "selected"; ?>>3
                    
                    
                    <OPTION value="4"
                        <?php if($student_row['current_grade'] == "4") echo "selected"; ?>>4
                    
                    
                    <OPTION value="5"
                        <?php if($student_row['current_grade'] == "5") echo "selected"; ?>>5
                    
                    
                    <OPTION value="6"
                        <?php if($student_row['current_grade'] == "6") echo "selected"; ?>>6
                    
                    
                    <OPTION value="7"
                        <?php if($student_row['current_grade'] == "7") echo "selected"; ?>>7
                    
                    
                    <OPTION value="8"
                        <?php if($student_row['current_grade'] == "8") echo "selected"; ?>>8
                    
                    
                    <OPTION value="9"
                        <?php if($student_row['current_grade'] == "9") echo "selected"; ?>>9
                    
                    
                    <OPTION value="10"
                        <?php if($student_row['current_grade'] == "10") echo "selected"; ?>>10
                    
                    
                    <OPTION value="11"
                        <?php if($student_row['current_grade'] == "11") echo "selected"; ?>>11
                    
                    
                    <OPTION value="12"
                        <?php if($student_row['current_grade'] == "12") echo "selected"; ?>>12
                    
                    
                    <OPTION value="13"
                        <?php if($student_row['current_grade'] == "13") echo "selected"; ?>>13
                    
                
                </SELECT>
            </div>
            <div class="form-group">
                <label>Gender</label> <SELECT autocomplete="off"
                    class="form-control" name="gender">
                    <option value="M"
                        <?php if($student_row['gender'] == "M") echo "SELECTED"; ?>>Male</option>
                    <option value="F"
                        <?php if($student_row['gender'] == "F") echo "SELECTED"; ?>>Female</option>
                    <option value="O"
                        <?php if ($student_row['gender'] == "O") echo "SELECTED"; ?>>Other</option>
                </SELECT>
            </div>
            <div class="form-group">
                <label>Student Number</label> <input autocomplete="off"
                    class="form-control" type="text" size="30"
                    maxsize="60" name="prov_ed_num"
                    value="<?php echo $student_row['prov_ed_num'];?>">
            </div>
            <div class="form-group">
                <label>Code</label> <input class="form-control"
                    type="text" value=""
                    placeholder="Do not use for now">
            </div>
            <button type="submit" value="submit"
                class="btn btn-primary btn-large">Update Student
                Information</button>
