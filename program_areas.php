...
<?php print_student_navbar($student_id, $student_row['first_name'] . " " . $student_row['last_name']); ?>
    <?php print_jumbotron_with_page_name("Goal Areas", $student_row['first_name'] . " " . $student_row['last_name'], $our_permission); ?>
<?php if ($system_message) { echo "<center><table width=\"80%\"><tr><td><p class=\"message\">" . $system_message . "</p></td></tr></table></center>";} ?>

<!-- BEGIN add supervisor -->
    <center>
        <form name="addsupervisor" enctype="multipart/form-data"
            action="<?php echo IPP_PATH . "program_area.php"; ?>"
            method="get"
            ...
            <table border="0" cellspacing="0" cellpadding="0"
                ...
                <tr>
                    <td colspan="3">
                        ...
                        type="hidden" name="add_area" value="1"> <input
                        type="hidden" name="student_id"
                        value="<?php echo $student_id; ?>">
                    </td>
                </tr>
                <tr>
                    <td valign="bottom" bgcolor="#E0E2F2">Area</td>
                    <td bgcolor="#E0E2F2"><input type="text"
                        name="program_area" size="30" maxsize="255"
                        value="<?php echo $_GET['program_area']; ?>"
                        onkeypress="return autocomplete(this,event,popuplist)">
                        &nbsp;<img
                        src="<?php echo IPP_PATH . "images/choosericon.png"; ?>"
                        height="17" width="17" border=0
                        onClick="popUpChooser(this,document.all.program_area)">
                    </td>
                    <td valign="center" align="center" bgcolor="#E0E2F2"
                        rowspan="2"><input type="submit" name="add"
                        value="add"></td>
                </tr>
                <tr>
                    <td valign="bottom" align="center" bgcolor="#E0E2F2"
                        colspan="2">&nbsp;</td>
                </tr>
                <tr>
                    <td valign="bottom" align="center" bgcolor="#E0E2F2"
    ...
    <form name="programareahistory" onSubmit="return confirmChecked();"
