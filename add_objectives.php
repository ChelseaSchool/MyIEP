...
if ($system_message) {
    ...
    ?>
		...
		<div class="col-md-4">
			...
			<form spellcheck="true" name="edit_goal"
				enctype="multipart/form-data" action="goal_change_checker.php"
				method="post">
				<div class=form-group>
					<!-- Hidden -->
					<input type="hidden" name="student_id"
						value="<?php echo $student_id; ?>"><input type="hidden" name="lto"
						value="<?php echo $goal_id; ?>"> <input type="hidden"
						name="update_goal" value="1">
					<!--  End hidden -->
					<div class="form-group">
						<label>Goal Area</label><select class="form-control" required class="form-control"
    ...
    ?>
						...
						<textarea class="form-control" spellcheck="true" class="form-control" name="goal_text"
							spellcheck="true" rows="5"><?php if (isset($goal_row['goal'])) echo $goal_row['goal']; ?></textarea>
						</div>
						<div class="form-group">
						<label for="goal_review_data">Review Date</label><input class="form-control datepicker"
					...
					<button class="btn btn-lg btn-primary" type="submit" name="Update"
						value="Update">Submit Revision</button>
		...
		<form name="add_objective" enctype="multipart/form-data"
			...
			<?php if(!$have_write_permission) echo "onSubmit=\"return noPermission();\"" ?>>
				...
				<input type="hidden" name="student_id"
					value="<?php echo $student_id; ?>"> <input type="hidden" name="lto"
					value="<?php echo $goal_id; ?>"> <input type="hidden"
					name="add_objective" value="1"> <input type="hidden" name="goal"
					value="<?php echo $goal; ?>"> <input type="hidden"
					name="student_first_name" value="$student_row['first_name']"> <input
					type="hidden" name="student_last_name"
				...
				<div class="form-group">
					...
					<div class="form-group">
					<label for="objective_review_date">Review Date (YYYY-MM-DD)</label><input required
						type="datepicker" autocomplete="off"
						class="form-control datepicker" name="objective_review_date"
					...
					<textarea required class="form-control" spellcheck="true"
						spellcheck="true" name="assessment_procedure" tabindex="3"
						cols="35" rows="3" wrap="soft">
						<?php if(isset($_POST['assessment_procedure'])) echo $_POST['assessment_procedure']; ?>
					</textarea>
					</div>
					<div class="form-group">
					<label for="strategies">Strategies</label>
					<textarea required class="form-control" spellcheck="true"
						spellcheck="true" name="strategies" tabindex="4" cols="40"
						rows="3" wrap="soft">
						<?php if(isset($_POST['strategies'])) echo $_POST['strategies']; ?>
					</textarea>
					</div>
					<div class="form-group">
					<label for="results_and_recommendations">Progress Review</label>
					<textarea class="form-control" placeholder="Maybe not yet."
						spellcheck="true" spellcheck="true"
						name="results_and_recommendations" tabindex="5" cols="40" rows="3"
						wrap="soft">
						<?php if(isset($_POST['results_and_recommendations'])) echo $_POST['results_and_recommendations']; ?>
					</textarea>
					</div>
				
				<button class="btn btn-lg btn-primary" type="submit" tabindex="6"
					name="Add" value="Add">Add Objective</button>
					</form>
				</div>
