...
$goal_id = "";
if (isset ( $_POST ['lto'] ))
	$goal_id = mysql_real_escape_string ( $_POST ['lto'] );
if (isset ( $_GET ['lto'] ))
	$goal_id = mysql_real_escape_string ( $_GET ['lto'] );
...
if (isset ( $_POST ['update_goal'] ) && $have_write_permission) {
	if ($_POST ['goal_description'] == "")
		$system_message = $system_message . "You must supply goal text<BR>";
	else {
...
function echoJSServicesArray() {
	...
	if (! $asslist_result) {
		...
		if (mysql_num_rows ( $asslist_result ))
			echo createJavaScript ( $asslist_result, "popuplist" );
	}
}
/**
...
<BODY>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown"><a href="#"
                        ...
                        <ul class="dropdown-menu">
                            <li><a
                                href="<?php echo IPP_PATH . "long_term_goal_view.php?student_id=" . $student_row['student_id']; ?>">Goals</a>
                            </li>
                            <li class="divider"></li>
                            <li><a
                                href="<?php echo IPP_PATH . "guardian_view.php?student_id=" . $student_row['student_id'];?>">Guardians</a>
                            </li>
                            <li><a
                            ...
                            <li><a
                                href="<?php echo IPP_PATH . "medical_info.php?student_id=" . $student_row['student_id'];?>">Medical
                                    Information</a></li>
                            <li><a
                                href="<?php echo IPP_PATH . "medication_view.php?student_id=" . $student_row['student_id'];?>">Medication</a>
                            </li>
                            <li><a
                            ...
                            <li><a
                                href="<?php echo IPP_PATH . "year_end_review.php?student_id=" . $student_row['student_id'];?>">Year-End
                                    Review</a></li>
                            <li><a
                                href="<?php echo IPP_PATH . "anecdotals.php?student_id=" . $student_row['student_id'];?>">Anecdotals</a>
                            </li>
                            <li><a
                            ...
                            <li><a
                                href="<?php echo IPP_PATH . "transition_plan.php?student_id=" . $student_row['student_id'];?>">Transition
                                    Plan</a></li>
                            <li><a
                                href="<?php echo IPP_PATH . "accomodations.php?student_id=" . $student_row['student_id'];?>">Accomodations</a>
                            </li>
                            <li><a
                                href="<?php echo IPP_PATH . "snapshots.php?student_id=" . $student_row['student_id'];?>">Snapshots</a>
                            </li>
                        </ul>
	...
	<div class="container">
        ...
        <div class="col-md-4">
            <h3>Edit Goal</h3>
            <!-- Form Begins -->
            <form spellcheck="true" name="edit_goal"
                enctype="multipart/form-data"
                action="goal_change_checker.php" method="post">
                <div class=form-group>
                    <!-- Hidden -->
                    <input type="hidden" name="student_id"
                        value="<?php echo $student_id; ?>"><input
                        type="hidden" name="lto"
                        value="<?php echo $goal_id; ?>"> <input
                        type="hidden" name="update_goal" value="1">
                    <!--  End hidden -->
                    <div class="form-group">
                        <label>Goal Area</label><select
                            class="form-control" required
                            class="form-control" name="goal_area"
                            placeholder="Choose Goal Area"
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"
                                ...
                                name="goal_text" spellcheck="true"
                                rows="5"><?php if (isset($goal_row['goal'])) echo $goal_row['goal']; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="goal_review_data">Review Date</label><input
                                class="form-control datepicker"
                                autocomplete="off" type="datepicker"
                                id="datepicker" name="goal_review_date"
                                data-provide="datepicker"
                                data-date-format="yyyy-mm-dd"
                                value="<?php echo $goal_review_date; ?>">
                        </div>
                    </div>
                    <button class="btn btn-lg btn-primary" type="submit"
                        name="Update" value="Update">Submit Revision</button>
    ...
    <div class="col-md-4">
        ...
        <form name="add_objective" enctype="multipart/form-data"
            action="<?php echo IPP_PATH . "add_objective_receipt.php"; ?>"
            method="post"
            ...
            <input type="hidden" name="student_id"
                ...
                name="lto" value="<?php echo $goal_id; ?>"> <input
                type="hidden" name="add_objective" value="1"> <input
                type="hidden" name="goal" value="<?php echo $goal; ?>">
            <input type="hidden" name="student_first_name"
                value="$student_row['first_name']"> <input type="hidden"
                name="student_last_name"
                value="$student_row['last_name']">
            <!-- End Hidden -->
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    spellcheck="true" name="objective" tabindex="1"
                    cols="40" rows="3" wrap="soft"><?php if(isset($_POST['objective'])) echo $_POST['objective']; ?></textarea>
            </div>
            <div class="form-group">
                <label for="objective_review_date">Review Date
                    (YYYY-MM-DD)</label><input required
                    type="datepicker" autocomplete="off"
                    class="form-control datepicker"
                    name="objective_review_date"
                    data-provide="datepicker"
                    data-date-format="yyyy-mm-dd" tabindex="2"
                    value="<?php if(isset($_POST['review_date'])) echo $_POST['review_date']; ?>">
            </div>
            <div class="form-group">
                <label for="assessment_procedure">Assessment Procedure</label>
                <textarea class="form-control" spellcheck="true"
                    placeholder="Ex. Assessed quarterly."
                    name="assessment_procedure" tabindex="3" cols="35"
                    rows="3" wrap="soft"><?php if(isset($_POST['assessment_procedure'])) echo $_POST['assessment_procedure']; ?></textarea>
            </div>
            <div class="form-group">
                <label for="strategies">Strategies</label>
                <textarea required class="form-control"
                    placeholder="Ex. Observation log." spellcheck="true"
                    name="strategies" tabindex="4" cols="40" rows="3"
                    wrap="soft"><?php if(isset($_POST['strategies'])) echo $_POST['strategies']; ?></textarea>
            </div>
            <div class="form-group">
                <label for="results_and_recommendations">Progress Review</label>
                <textarea class="form-control"
                    placeholder="Ex. Not Initiated." spellcheck="true"
                    spellcheck="true" name="results_and_recommendations"
                    tabindex="5" cols="40" rows="3" wrap="soft">
<?php if(isset($_POST['results_and_recommendations'])) echo $_POST['results_and_recommendations']; ?></textarea>
            </div>

            <button class="btn btn-lg btn-primary" type="submit"
                tabindex="6" name="Add" value="Add">Add Objective</button>
        </form>
    </div>
